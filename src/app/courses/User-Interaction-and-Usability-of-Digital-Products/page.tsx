...
const User_Interaction_and_Usability_of_Digital_ProductsPage = () => {
  const courseCode = 'CS5.401';
...
export default User_Interaction_and_Usability_of_Digital_ProductsPage;
