...
const Continuous_Variable_Quantum_Information_Theory_and_ComputationPage = () => {
  const courseCode = 'MA7.501';
...
export default Continuous_Variable_Quantum_Information_Theory_and_ComputationPage;
