...
const Digital_Democracy_and_Data_Governance_in_the_European_UnionPage = () => {
  const courseCode = 'HS4.303';
...
export default Digital_Democracy_and_Data_Governance_in_the_European_UnionPage;
