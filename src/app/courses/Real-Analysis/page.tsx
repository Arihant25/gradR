...
const RAPage = () => {
  ...
  const calculateMarks = () => {
    ...
    let ass = (parseInt(formData.assignment) / 10) * 10;
    let mid = (parseInt(formData.midSem) / 100) * 25;
    let end = (parseInt(formData.endSem) / 100) * 35;
    let quiz = ((parseInt(formData.quiz1) / 10) + (parseInt(formData.quiz2) / 10)) * 15;
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 text-black">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white p-6 sm:p-10 rounded-lg shadow-xl border-2 border-gray-300">
          <div className="mb-10">
            <h2 className="text-3xl sm:text-5xl font-bold text-center text-gray-800 shadow-text">Real Analysis</h2>
          </div>
          <div className="mb-8 animate-fade-in animate-delay-500">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">Assignment (out of 10)</h3>
              <input
                type="number"
                name="assignment"
          ...
          <div className="mb-8 animate-fade-in">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">Quiz 1 (out of 10)</h3>
            <input
              type="number"
              name="quiz1"
