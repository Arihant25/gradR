...
const DSMPage = () => {
  ...
  const calculateMarks = () => {
    ...
    let lab = (parseInt(formData.labs) / 35) * 10;
    let mid = (parseInt(formData.midSem) / 40) * 25;
    let end = (parseInt(formData.endSem) / 70) * 35;
    let quiz = ((parseInt(formData.quiz1) / 40) + (parseInt(formData.quiz2) / 40)) * 15;
    let final = lab + mid + end + quiz;
    console.log(lab, mid, end, quiz, final);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 text-black">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white p-6 sm:p-10 rounded-lg shadow-xl border-2 border-gray-300">
          <div className="mb-10">
            <h2 className="text-3xl sm:text-5xl font-bold text-center text-gray-800 shadow-text">Digital Systems and Microcontrollers</h2>
          </div>
          <div className="mb-8 animate-fade-in animate-delay-500">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">Lab (out of 35)</h3>
              <input
                type="number"
                name="labs"
                value={formData.labs}
          ...
          <div className="mb-8 animate-fade-in">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">Quiz 1 (out of 40)</h3>
            <input
              type="number"
              name="quiz1"
          ...
          <div className="mb-8 animate-fade-in animate-delay-100">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">MidSem (out of 40)</h3>
            <input
              type="number"
              name="midSem"
          ...
          <div className="mb-8 animate-fade-in animate-delay-200">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">Quiz 2 (out of 40)</h3>
            <input
              type="number"
              name="quiz2"
          ...
          <div className="mb-8 animate-fade-in animate-delay-400">
            <h3 className="text-lg sm:text-xl font-semibold mb-2 text-gray-700">End Sem (out of 70)</h3>
            <input
              type="number"
              name="endSem"
