...
const Linear_partial_differential_equations_and_variational_calculusPage = () => {
  const courseCode = 'MA4.303';
...
export default Linear_partial_differential_equations_and_variational_calculusPage;
