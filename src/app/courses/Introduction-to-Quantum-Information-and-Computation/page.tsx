...
const Introduction_to_Quantum_Information_and_ComputationPage = () => {
  const courseCode = 'CS9.312';
...
export default Introduction_to_Quantum_Information_and_ComputationPage;
